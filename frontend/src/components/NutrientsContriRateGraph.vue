...
// 共通データはここで固定
const labels = ["たんぱく質","食物繊維総量","カリウム","カルシウム","マグネシウム","鉄","亜鉛","ビタミンA","ビタミンD","ビタミンB1","ビタミンB2","ビタミンB6","葉酸","ビタミンC"]   // 栄養素名
const targets = [100, 100, 100, 100, 100, 100, 100, 100, 100, 100, 100, 100, 100, 100]  // 目標値
